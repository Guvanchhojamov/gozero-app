...
const (
	UserAuthService_SignUp_FullMethodName = "/auth.UserAuthService/SignUp"
	UserAuthService_SignIn_FullMethodName = "/auth.UserAuthService/SignIn"
)
...
func (c *userAuthServiceClient) SignUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*SignUpResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserAuthService_SignUp_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UserAuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "gateway/services/authorization/protos/v1/auth.proto",
}
